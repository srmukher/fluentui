...
interface IAxisProps {
  ...
  culture: string;
  tickParams: any;
  datasetForXAxisDomain: any;
  timeFormatLocale: any;
  customDateTimeFormatter: any;
  useUTC: boolean;
  dateLocalizeOptions: any;
}
...
export const Axis: React.FC<IAxisProps> = props => {
  ...
  }, [xAxisElement, yAxisElement, yAxisElementSecondary, margins, svgDimensions, yScale, xAxis]);
