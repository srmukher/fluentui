...
// @public (undocumented)
export type FluentChart = 'area' | 'composite' | 'donut' | 'fallback' | 'gauge' | 'groupedverticalbar' | 'heatmap' | 'horizontalbar' | 'line' | 'scatter' | 'scatterpolar' | 'sankey' | 'sunburst' | 'table' | 'verticalstackedbar' | 'gantt';
