...
const _getPointPath = (x: number, y: number, w: number, index: number): string => {
  const allPointPaths = [
    ...
    `M${x - 0.5001 * w} ${y - 1.207 * w}
     ...
     Z`,
    //cross
    `M${x - w / 2} ${y - w / 2} L${x + w / 2} ${y - w / 2} L${x + w / 2} ${y - w / 6} L${x + w / 6} ${y - w / 6} L${
      x + w / 6
    } ${y + w / 6} L${x + w / 2} ${y + w / 6} L${x + w / 2} ${y + w / 2} L${x - w / 2} ${y + w / 2} L${x - w / 2} ${
      y + w / 6
    } L${x - w / 6} ${y + w / 6} L${x - w / 6} ${y - w / 6} L${x - w / 2} ${y - w / 6} Z`,
    //x
    `M${x - w / 2} ${y - w / 2} L${x - w / 6} ${y - w / 6} L${x + w / 6} ${y + w / 6} L${x + w / 2} ${y + w / 2} L${
      x + w / 6
    } ${y + w / 6} L${x - w / 6} ${y - w / 6} Z M${x + w / 2} ${y - w / 2} L${x + w / 6} ${y - w / 6} L${x - w / 6} ${
      y + w / 6
    } L${x - w / 2} ${y + w / 2} L${x - w / 6} ${y + w / 6} L${x + w / 6} ${y - w / 6} Z`,
    //rectangle
    `M${x - w / 2} ${y - w / 3} L${x + w / 2} ${y - w / 3} L${x + w / 2} ${y + w / 3} L${x - w / 2} ${y + w / 3} Z`,
  ];
