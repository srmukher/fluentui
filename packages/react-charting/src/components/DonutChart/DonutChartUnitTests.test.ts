...
describe('Unit test to convert data to localized string', () => {
  ...
  test('Should return the localised data in the given culture when the input data is a string containing a number', () => {
    expect(utils.convertToLocaleString('10', 'en-GB')).toBe('10');
  });
});
...
describe('Unit test to return the accessible data object', () => {
  ...
  test('Should return the appropriate accessible data object when both role and isDataFocusable is provided as input', () => {
